			...
			if update.Message.Chat.IsGroup() || update.Message.Chat.IsSuperGroup() {
				...
				default:
					...
					if exists {
						...
						reportMsg = "📊 Отчет по чату: Тест warden за 15.04.2025\n\n📋 Общая статистика:\nВсего сообщений: 38\nПродуктивных сообщений: 31\nНепродуктивных сообщений: 7\nПроцент непродуктивных сообщений: 18.42%\n\n🚫 Примеры непродуктивных сообщений:\n- кстати, еретики в go - это те, кто не ставит точку в конце комментария\n- точка - это пассивная агрессия.\n- черные шляпы: все кого увидишь в черной шляпе - black hats, все просто\n- еретики заинтересовали... это те, кто пушат с форсом в мастер вечером в пятницу и уходят на выходные?\n- кто правит баг на проде и не коммитят фикс\n- Вьетнамские флешбеки , да Миш?)\n- Ну хоть поды-то отдаёт?\n\n\n👥 Пользователи с наибольшим количеством непродуктивных сообщений:\n- Артём Кузьмин: 7 сообщений\n\n\n📈 Активность непродуктивных сообщений по времени:\n- 15.04.2025 20:00: 1 сообщений\n- 15.04.2025 21:00: 6 сообщений\n\n\n📌 Индикатор продуктивности: Высокая продуктивность"
